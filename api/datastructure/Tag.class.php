...
class Tag
{
    ...
    public static function Array2Tag($arr)
    {
        $tag = new Tag();
    ...
    public static function CheckTagAddUserArgs($tagId, $userIdList, $partyIdList)
    {
    ...
    public static function ToTagAddUserArray($tagId, $userIdList, $partyIdList)
    {
        $args = array();
